...
### **1. Распознавание лиц с помощью камер **{red}(под вопросом)****
...
### **5. Умная перекличка через голосовые технологии **{red}(под вопросом)****
...
### **7. Распознавание по фотографиям группы **{red}(под вопросом)****
...
### **8. Биометрические датчики **{red}(под вопросом)****
...
### **10. Распознавание жестов **{red}(под вопросом)****
